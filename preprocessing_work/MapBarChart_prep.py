...
bee_df = bee_df[(1994 <= bee_df['year']) & (bee_df['year'] <= 2017)]
...
print(bee_df[bee_df['year'] == 2015].sum())
...
bee_df_normal = bee_df.copy()
neonic_df_normal = neonic_df.copy()

bee_df_normal['Bee Count'] = (bee_df['Bee Count']-bee_df['Bee Count'].min())/(bee_df['Bee Count'].max()-bee_df['Bee Count'].min())
...
bee_df_normal.to_csv('../preprocessed_bee_data/bee_summary_chart_normalized.csv')
neonic_df_normal.to_csv('../preprocessed_bee_data/neonic_summary_chart_normalized.csv')
